...
def build_server(cuda=False, rocm=False):
    ...
    args.extend(
        [
            ...
            # Verify-loop / advanced-options modules (some are imported lazily,
            # so PyInstaller's static analysis can miss them in a frozen build).
            "--hidden-import",
            "backend.utils.param_spec",
            "--hidden-import",
            "backend.utils.verify",
            "--hidden-import",
            "backend.utils.chunked_tts",
            "--hidden-import",
